...
class Marcacao(models.Model):
    ...
    motivo = models.ForeignKey(
        'Motivo', on_delete=models.CASCADE, verbose_name='Motivo', default=False
    )
    protese = models.CharField('Usa prótese', max_length=1, choices=P, default=False)
    ativo = models.BooleanField('Consulta ativa:', default=True)
    create_on = models.DateField('Criado em:', auto_now_add=True)
    update_on = models.DateField('Atualizado em:', auto_now=True)
    user = models.ForeignKey(
        'Usuario', editable=False, on_delete=models.CASCADE, verbose_name='Usuário'
    )
